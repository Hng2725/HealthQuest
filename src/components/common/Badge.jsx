  ...
  return (
    <span
      className={cn(
        ...
        {
          'bg-white text-slate-600 border border-slate-200 shadow-sm': variant === 'default',
          'bg-primary/20 text-primaryHover border border-primary/50 font-bold': variant === 'primary',
